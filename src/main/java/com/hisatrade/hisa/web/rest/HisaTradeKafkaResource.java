...
@RestController
@RequestMapping("/api/hisa-trade-kafka")
public class HisaTradeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HisaTradeKafkaResource.class);
    ...
    public HisaTradeKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
